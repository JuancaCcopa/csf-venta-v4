...
@Component({
  selector: 'app-panel-atencion-transferencia-ext',
  templateUrl: './panel-atencion-transferencia-ext.component.html',
  styleUrls: ['./panel-atencion-transferencia-ext.component.css']
})

export class PanelAtensionTransferenciaExtComponent implements OnInit {
  ...
  constructor(
    ...
    private readonly atencionSolicitudTrasladoService: AtencionTrasladoService,
