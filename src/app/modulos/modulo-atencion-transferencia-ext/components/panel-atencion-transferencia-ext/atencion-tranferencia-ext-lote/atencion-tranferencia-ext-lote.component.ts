...
@Component({
  selector: 'app-atencion-tranferencia-ext-lote',
  templateUrl: './atencion-tranferencia-ext-lote.component.html',
  styleUrls: ['./atencion-tranferencia-ext-lote.component.css']
})

export class AtencionTransferenciaExtLoteComponent implements OnInit {
