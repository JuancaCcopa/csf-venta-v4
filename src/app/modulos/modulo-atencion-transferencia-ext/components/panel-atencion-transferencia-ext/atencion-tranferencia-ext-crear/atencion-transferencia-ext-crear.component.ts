...
@Component({
  selector: 'app-atencion-transferencia-ext-crear',
  templateUrl: './atencion-transferencia-ext-crear.component.html',
  styleUrls: ['./atencion-transferencia-ext-crear.component.css']
})

export class AtensionTransferenciaExtCrearComponent implements OnInit {
  ...
  constructor(
    ...
    public atencionSolicitudTrasladoService: AtencionTrasladoService,
