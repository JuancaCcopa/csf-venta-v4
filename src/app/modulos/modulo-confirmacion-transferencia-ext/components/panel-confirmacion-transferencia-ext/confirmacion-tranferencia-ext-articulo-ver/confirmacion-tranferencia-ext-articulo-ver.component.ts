...
@Component({
  selector: 'app-confirmacion-tranferencia-ext-articulo-ver',
  templateUrl: './confirmacion-tranferencia-ext-articulo-ver.component.html',
  styleUrls: ['./confirmacion-tranferencia-ext-articulo-ver.component.scss'],
})

export class ConfirmacionTrasladoExtArticuloVerComponent implements OnInit {
