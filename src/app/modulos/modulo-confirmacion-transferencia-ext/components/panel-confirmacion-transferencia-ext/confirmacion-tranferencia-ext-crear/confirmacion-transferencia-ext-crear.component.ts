...
@Component({
  selector: 'app-confirmacion-transferencia-ext-crear',
  templateUrl: './confirmacion-transferencia-ext-crear.component.html',
  styleUrls: ['./confirmacion-transferencia-ext-crear.component.css']
})

export class ConfirmacionTransferenciaExtCrearComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    public confirmacionSolicitudTrasladoService: ConfirmacionTrasladoService,
