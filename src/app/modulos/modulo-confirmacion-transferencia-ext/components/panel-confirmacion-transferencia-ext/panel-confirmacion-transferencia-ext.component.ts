...
@Component({
  selector: 'app-panel-confirmacion-transferencia-ext',
  templateUrl: './panel-confirmacion-transferencia-ext.component.html',
  styleUrls: ['./panel-confirmacion-transferencia-ext.component.css']
})

export class PanelConfirmacionTransferenciaExtComponent implements OnInit {
