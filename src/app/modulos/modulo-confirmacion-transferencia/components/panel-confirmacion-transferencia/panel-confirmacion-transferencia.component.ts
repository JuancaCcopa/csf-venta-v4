...
@Component({
  selector: 'app-panel-confirmacion-transferencia',
  templateUrl: './panel-confirmacion-transferencia.component.html',
  styleUrls: ['./panel-confirmacion-transferencia.component.css']
})

export class PanelConfirmacionTransferenciaComponent implements OnInit {
   // Titulo del componente
   titulo = 'Confirmación de Solicitud de Transferencia - Interno';
  ...
  tituloModalAtencionSolicitud: String="Transferencia de stock - interno";
  ...
  constructor(
    ...
    private readonly confirmacionSolicitudTrasladoService: ConfirmacionTrasladoService,
  ...
  onListar() {
    ...
    this.idResaltar = (this.sessionStorage.getItemDecrypt('idconfirmacionsolicitudtraslado'))? parseInt(this.sessionStorage.getItemDecrypt('idconfirmacionsolicitudtraslado')):0;
        ...
        map((resp:any) => {
          ...
          .subscribe(
            ...
            (error) => {
              ...
              this.messageService.add({key: 'myKeyCrear', severity:'error', summary: 'Mensaje', detail: ` ERROR DE ENVIAR A SAP BO LA SOLICITUD`});
