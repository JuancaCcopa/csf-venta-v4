...
@Component({
  selector: 'app-confirmacion-tranferencia-lote',
  templateUrl: './confirmacion-tranferencia-lote.component.html',
  styleUrls: ['./confirmacion-tranferencia-lote.component.css']
})

export class ConfirmacionTransferenciaLoteComponent implements OnInit {
