...
@Component({
  selector: 'app-confirmacion-transferencia-crear',
  templateUrl: './confirmacion-transferencia-crear.component.html',
  styleUrls: ['./confirmacion-transferencia-crear.component.css']
})

export class ConfirmacionTransferenciaCrearComponent implements OnInit {
