...
const routes: Routes = [
  ...
  {path: 'main',
    ...
    children: [
      ...
      () => import('./modulos/modulo-confirmacion-transferencia/modulo-confirmacion-transferencia.module')
      .then(m => m.ConfirmacionTransferenciaModule),
      canActivate: [AuthGuard]},
      ...
      () => import('./modulos/modulo-atencion-transferencia-ext/modulo-atencion-transferencia-ext.module')
      .then(m => m.AtencionTransferenciaExtModule),
      canActivate: [AuthGuard]},
      { path: 'modulo-cx' , loadChildren:
      () => import('./modulos/modulo-confirmacion-transferencia-ext/modulo-confirmacion-transferencia-ext.module')
      .then(m => m.ConfirmacionTransferenciaExtModule),
      canActivate: [AuthGuard]},
